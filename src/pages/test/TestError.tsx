  ...
  return (
    <div className="dark flex min-h-screen flex-col items-center justify-center bg-background text-center">
      <div className="relative">
        <div className="absolute inset-0 rounded-lg bg-linear-to-r from-red-500 to-orange-500 opacity-60 blur-lg"></div>
      ...
      <div className="mt-2">
        <h2 className="font-manrope text-8xl font-bold text-foreground">Something went wrong</h2>
      </div>
